...
<p>للحصول على معلومات تفصيلية حول الحصول على تصريح إقامة في Türkiye، راجع مقالنا بعنوان "<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/oturma-izni-nasil-alinir/"><strong><u>كيفية الحصول على تصريح إقامة (إkamet izni)؟</u></strong></a>".</p>`,
  ...
  {
    title: "دعوى إبطال قرار رفض طلب تصريح الإقامة طويل الأمد",
    content: `<p>كما اُوضح بالتفصيل أعلاه، تُفحص طلبات تصريح الإقامة طويل الأمد المقدمة من الأجانب الذين يستوفون الشروط القانونية من قبل الإدارة ويُبت فيها. في بعض الحالات، قد ترفض الإدارة هذه الطلبات لأسباب مختلفة. قد تشمل أسباب الرفض عدم استيفاء الشروط المنصوص عليها في التشريع، أو التقديم بمستندات ناقصة أو خاطئة، أو قرار رفض ضمن سلطة الإدارة التقديرية.</p>
<p>يجوز للأجانب الذين رُفض طلب تصريح الإقامة طويل الأمد لهم رفع دعوى إبطال إذا رأوا أن قرار الرفض غير قانوني. يجب رفع هذه الدعاوى أمام المحكمة الإدارية في مكان الجهة التي أصدرت القرار. مهلة رفع الدعوى 60 يوماً من تاريخ إبلاغ قرار الرفض للمعني.</p>
<p>قرارات الإدارة برفض أو قبول طلب تصريح الإقامة طويل الأمد هي في جوهرها إجراءات إدارية. لذلك، لكي تكون الإجراءات الإدارية مشروعة، يجب أن تتضمن جميع العناصر المطلوبة. كما اُوضح في مقالنا "<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/idari-islemlerin-iptali-davasi/"><strong><u>إبطال الإجراءات الإدارية</u></strong></a>"، يمكن للمحكمة إبطال الإجراءات الإدارية التي يتبين أن أحد عناصر الهدف أو الموضوع أو السبب أو الاختصاص أو الشكل فيها معيباً على الأقل.</p>
...
<p>Для подробной информации о получении вида на жительство в Türkiye см. нашу статью «<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/oturma-izni-nasil-alinir/"><strong><u>Как получить вид на жительство (ikamet izni)?</u></strong></a>».</p>`,
  ...
  {
    title: "Иск об отмене решения об отказе в заявлении о долгосрочном виде на жительство",
...
<p>برای اطلاعات تفصیلی درباره گرفتن مجوز اقامت در Türkiye، مقاله «<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/oturma-izni-nasil-alinir/"><strong><u>چگونه مجوز اقامت (ikamet izni) بگیریم؟</u></strong></a>» را ببینید.</p>`,
  ...
  {
    title: "دادخواست ابطال تصمیم رد درخواست مجوز اقامت بلندمدت",
    content: `<p>همان‌طور که در بالا به تفصیل توضیح داده شد، درخواست‌های مجوز اقامت بلندمدت اشخاصی که شرایط قانونی را برآورده می‌کنند توسط اداره بررسی و درباره آنها تصمیم گرفته می‌شود. در برخی موارد اداره ممکن است این درخواست‌ها را به دلایل مختلف رد کند. دلایل رد می‌تواند عدم برآورده شدن شرایط مقرر در قانون، ارائه مدارک ناقص یا نادرست، یا تصمیم رد در چارچوب اختیار تقدیری اداره باشد.</p>
<p>اتباع خارجی که درخواست مجوز اقامت بلندمدت آنها رد شده اگر تصمیم رد را غیرقانونی بدانند می‌توانند دادخواست ابطال بدهند. این دادخواست‌ها باید در دادگاه اداری محل مرجعی که تصمیم را صادر کرده اقامه شود. مهلت اقامه دادخواست 60 روز از تاریخ ابلاغ رد درخواست به ذی‌نفع است.</p>
<p>تصمیمات اداره درباره رد یا پذیرش درخواست مجوز اقامت بلندمدت اساساً اقدامات اداری هستند. بنابراین برای مشروعیت اقدامات اداری باید تمام عناصر لازم را داشته باشند. همان‌طور که در مقاله «<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/idari-islemlerin-iptali-davasi/"><strong><u>ابطال اقدامات اداری</u></strong></a>» توضیح داده شده، اقدامات اداری که حداقل یکی از عناصر هدف، موضوع، علت، صلاحیت یا شکل آنها معیوب باشد می‌توانند توسط دادگاه ابطال شوند.</p>
...
<p>حقوق ترکیه به طرفین اجازه می‌دهد خود را در دادگاه دفاع و نمایندگی کنند و استخدام وکیل برای نمایندگی جز در موارد استثنایی الزامی نیست. در دادگاه‌های اداری نیز الزام به استخدام وکیل حقوق اداری وجود ندارد.<br>اما به‌دلیل پیچیدگی قوانین حقوق اداری و کوتاه بودن مهلت‌های قانون آیین دادرسی اداری، افراد غیرحقوقی ممکن است خطاهای شکلی یا ماهوی غیرقابل جبران مرتکب شوند. برای جلوگیری از از دست رفتن حقوق در فرایند دقیق دادرسی اداری، پیش از هر اقدامی توصیه می‌کنیم از وکلای فعال در «<a target="_blank" rel="noopener noreferrer nofollow" class="text-csg-blue underline cursor-pointer" href="https://kulacoglu.av.tr/calismaalanlarimiz/idare-hukuku/"><strong><u>حقوق اداری</u></strong></a>» پشتیبانی حقوقی بگیرید.</p><p><strong>درخواست مجوز اقامت بلندمدت کجا ارائه می‌شود؟</strong></p>
...
export const contentSlug = "uzun-donem-oturma-izni-ikamet-izni-nasil-alinir";
