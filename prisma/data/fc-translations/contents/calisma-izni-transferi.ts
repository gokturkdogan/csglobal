...
const faSections: ServiceContentSection[] = [
  {
    ...
    content: "<p>انتقال مجوز کار سازوکار حقوقی است که کارگران خارجی وابسته به یک کارفرما برای تغییر شعبه یا وظیفه خود در آن شعبه از آن استفاده می‌کنند. تغییر سمت در محل کار یا انتقال به بخش دیگر از موارد رایج است.</p>",
  },
  {
    title: "انتقال مجوز کار چیست؟",
    content: "<p>انتقال مجوز کار مجوزی است که به خارجی دارای مجوز وابسته به یک کارفرما اجازه می‌دهد در سمت دیگر در همان محل کار یا در شعب دیگر همان کارفرما در همان حوزه فعالیت کار کند. در عمل، انتقال معمولاً هنگام تغییر شعبه یا سمت در همان محل کار انجام می‌شود.</p><p>مجوز صادرشده برای یک کارفرما را نمی‌توان به محل کار کارفرمای دیگر منتقل کرد. از طریق انتقال (تغییر محل کار) می‌توان شعبه یا سمت را در همان کارفرما تغییر داد.</p>",
  },
  {
    title: "شرایط تغییر محل کار مجوز کار چیست؟",
    content: "<p>شرایط تغییر محل کار در ماده 26 آیین‌نامه اجرای قانون نیروی کار بین‌المللی تنظیم شده است.</p><p>شرایط به شرح زیر است:</p><ul>\n<li>درخواست تغییر باید توسط کارفرما ارائه شود.</li>\n\n\n\n<li>درخواست باید قبل از پایان مدت مجوز ارائه شود.</li>\n\n\n\n<li>درخواست باید از طریق سامانه e-permit و با بارگذاری الکترونیکی مدارک انجام شود.</li>\n\n\n\n<li>سمت یا کار در شعبه جدید نباید نیازمند پیش‌مجوز باشد.</li>\n\n\n\n<li>سمت جدید نباید از مشاغل نیازمند صلاحیت حرفه‌ای باشد و باید با شغل مندرج در قرارداد کار سازگار باشد.</li>\n\n\n\n<li>شعبه مقصد باید در اداره ثبت تجاری کارفرما ثبت شده باشد.</li>\n\n\n\n<li>درخواست باید توسط اداره کل نیروی کار بین‌المللی مناسب تشخیص داده شود.</li>\n</ul><p>اگر پس از رد درخواست انتقال، خارجی در محل یا سمت دیگر کار کند، مجوز باطل می‌شود و خارجی باید ظرف <strong>10 روز</strong> کشور را ترک کند. در غیر این صورت ممکن است اخراج شود.</p><p><strong>توجه: </strong>از طریق انتقال، کارگر خارجی می‌تواند در شعبه دیگر همان کارفرما در همان حوزه یا در سمت دیگر در همان محل کار فعالیت کند. تغییر کارفرما از طریق انتقال ممکن نیست. برای کار با کارفرمای دیگر باید مجوز فعلی لغو و مجوز جدید اخذ شود.</p>",
  },
  {
    title: "انتقال مجوز کار چگونه انجام می‌شود؟",
    content: "<p>انتقال توسط کارفرما از طریق سامانه e-permit اداره کل نیروی کار بین‌المللی در e-Devlet انجام می‌شود. پس از ورود، فرم‌های اطلاعات کارفرما و کارگر نمایش داده می‌شود. کارفرما با وارد کردن اطلاعات و بارگذاری مدارک درخواست را تکمیل می‌کند.</p><p>چون فرایند انتقال از نظر آیین شبیه درخواست عمومی مجوز کار است، می‌توانید مقاله «چگونه مجوز کار بگیریم» را بخوانید.</p>",
  },
  {
    title: "رد درخواست انتقال، اعتراض و دعوای ابطال",
    content: "<p>اگر هر شرط لازم برای تأیید درخواست انتقال وجود نداشته باشد، درخواست رد می‌شود. مثلاً اگر شعبه در اداره ثبت تجاری همان کارفرما ثبت نباشد، سمت جدید ناسازگار باشد یا مشمول پیش‌مجوز وزارت باشد، درخواست رد می‌شود. نقص مدارک نیز دلیل رد است.</p><p>علاوه بر موارد فوق، وزارت می‌تواند در صورت ناسازگاری با سیاست نیروی کار بین‌المللی درخواست را رد کند. علیه رد می‌توان اعتراض کرد یا دعوای ابطال طرح کرد.</p><p><strong>اعتراض‌ها</strong> ظرف <strong>30 روز</strong> از تاریخ ابلاغ رد به خارجی از طریق سامانه e-permit نزد وزارت ارائه می‌شوند. هنگام اعتراض باید لایحه حقوقی، مدارک پشتیبان و امضای الکترونیکی بارگذاری شود.</p><p><strong>دعوای ابطال</strong> ظرف 60 روز از روز بعد از ابلاغ در دادگاه اداری طرح می‌شود. اگر ابتدا اعتراض شده باشد، مهلت دعوا متوقف می‌شود. مثلاً اگر اعتراض در روز 32 انجام شود، 28 روز از تاریخ ابلاغ نتیجه اعتراض باقی می‌ماند.</p><p>در هر دو مسیر، لوایح باید مستدل باشند. ابتدا علت رد مشخص و سپس لوایح حقوقی تهیه شود. برای مدیریت مؤثر، مشورت با وکیل متخصص حقوق اتباع خارجی توصیه می‌شود.</p><p>برای جزئیات بیشتر مقاله «رد درخواست مجوز کار» را بخوانید.</p>",
  },
  {
    title: "نتیجه‌گیری",
    content: "<p>عدم رعایت شرایط یا اشتباه در آیین منجر به رد می‌شود. باید شرایط قانونی رعایت شود. اگر رد ناعادلانه باشد، می‌توان از اعتراض یا دعوای ابطال استفاده کرد. در این فرایند به مهلت‌ها و نگارش صحیح لوایح توجه کنید. مدیریت پرونده با وکیل حقوق اتباع خارجی مفید است.</p>",
  }
];

export const contentSlug = "calisma-izni-transferi";

export const contentTranslations: ForeignConsultancyTranslations = {
  en: {
    name: "Work Permit Transfer",
    excerpt: "Work permit transfer is the procedure that allows a foreign employee working under one employer to change branch within the same employer or to work in a different position at the same workplace. This guide explains eligibility, the e-permit process, refusal grounds, and appeal options.",
    shortDescription: "Work permit transfer allows a foreign employee tied to one employer to move to another branch in the same line of business or to a different role at the same workplace, subject to Ministry approval and procedural rules.",
    heroTitle: "Work Permit Transfer",
    heroSubtitle: "Learn how foreign employees may transfer an existing work permit to another branch or position of the same employer in Türkiye, which documents are required, and what to do if the transfer application is refused.",
    sectionsJson: serializeServiceSections(enSections),
  },
  ar: {
    name: "نقل تصريح العمل",
    excerpt: "نقل تصريح العمل هو الإجراء الذي يتيح للأجنبي العامل لدى صاحب عمل واحد تغيير الفرع أو المنصب داخل نفس صاحب العمل. يشرح هذا الدليل الشروط ونظام e-permit وأسباب الرفض وطرق الطعن.",
    shortDescription: "يسمح نقل تصريح العمل للأجنبي المرتبط بصاحب عمل واحد بالانتقال إلى فرع آخر في نفس قطاع النشاط أو إلى مهمة مختلفة في نفس مكان العمل، وفق موافقة الوزارة والقواعد الإجرائية.",
    heroTitle: "نقل تصريح العمل",
    heroSubtitle: "تعرّف كيف يمكن للأجانب نقل تصريح العمل الحالي إلى فرع أو منصب آخر لدى نفس صاحب العمل في Türkiye، والمستندات المطلوبة، وما يجب فعله عند رفض طلب النقل.",
    sectionsJson: serializeServiceSections(arSections),
  },
  ru: {
    name: "Перевод разрешения на работу",
    excerpt: "Перевод разрешения на работу позволяет иностранному работнику, занятому у одного работодателя, сменить филиал или должность в рамках того же работодателя. В статье описаны условия, подача через e-permit, основания отказа и обжалование.",
    shortDescription: "Перевод разрешения на работу дает иностранному работнику, привязанному к одному работодателю, возможность перейти в другой филиал той же отрасли или на иную должность на том же предприятии при одобрении Министерства.",
    heroTitle: "Перевод разрешения на работу",
    heroSubtitle: "Узнайте, как иностранный работник может перевести действующее разрешение на работу на другой филиал или должность того же работодателя в Türkiye, какие документы нужны и что делать при отказе.",
    sectionsJson: serializeServiceSections(ruSections),
  },
  fa: {
    name: "انتقال مجوز کار",
    excerpt: "انتقال مجوز کار رویه‌ای است که به کارگر خارجی وابسته به یک کارفرما امکان می‌دهد شعبه یا سمت خود را در همان کارفرما تغییر دهد. این راهنما شرایط، سامانه e-permit، دلایل رد و راه‌های اعتراض را توضیح می‌دهد.",
    shortDescription: "انتقال مجوز کار به کارگر خارجی وابسته به یک کارفرما اجازه می‌دهد در همان حوزه فعالیت به شعبه دیگر یا سمت متفاوت در همان محل کار منتقل شود، مشروط به تأیید وزارت و رعایت آیین‌نامه.",
    heroTitle: "انتقال مجوز کار",
    heroSubtitle: "بیاموزید چگونه کارگر خارجی می‌تواند مجوز کار فعلی را به شعبه یا سمت دیگر همان کارفرما در Türkiye منتقل کند، چه مدارکی لازم است و در صورت رد درخواست چه باید کرد.",
