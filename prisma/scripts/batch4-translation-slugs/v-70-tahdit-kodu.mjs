import { COMPETENT_COURT_TAHDIT, TAHDIT_COURT_COSTS } from "./_shared.mjs";
...
export default {
  ...
  ar: {
    ...
    excerpt:
      "يُفرض رمز التقييد V-70 على الأجانب الذين تثبت زواجهم الصوري للحصول على إقامة. قد يؤدي إلى الترحيل وحظر دخول Türkiye لمدة خمس سنوات وإلغاء إقامة العائلة ورفض الطلبات الجديدة. يشرح هذا الدليل الأسباب وإجراءات الإزالة والسبل القانونية.",
    shortDescription:
      "يُسجل رمز V-70 بحق الأجانب الذين يُعتبر زواجهم لأغراض الإقامة صورياً. يترتب عليه الترحيل وإلغاء التصريح وحظر إعادة الدخول لخمس سنوات، ويمكن الطعن فيه إدارياً وقضائياً.",
    heroTitle: "رمز التقييد V-70",
    heroSubtitle:
      "تعرّف معنى رمز V-70 وأسباب فرضه بعد ثبوت الزواج الصوري وكيفية إزالته بالطعن أو دعوى الإلغاء وخيارات التأشيرة المشروحة.",
    sections: [
      {
        title: "رمز التقييد V-70",
        content:
          "<p>يُفرض رمز التقييد V-70 على الأجانب الذين يُرحَّلون بسبب زواج صوري وتُمنع دخولهم إلى Türkiye لمدة خمس سنوات. ونتيجة لذلك قد يُسحب الجنسية التركية إن وُجدت، ويُلغى تصريح الإقامة. على الأجنبي المسجل بـ V-70 اللجوء إلى السبل القانونية لتجنب هذه العقوبات.</p>",
      },
      {
        title: "ما هو رمز التقييد V-70؟",
        content:
          "<p>رمز V-70 يُدرج في سجلات الأجانب الذين ثبت تعاقدهم على زواج صوري لمنع دخولهم إلى البلاد. يُلغى تصريح إقامة العائلة ويُرفض الطلب المتعلق بنفس السبب. لكن يمكن النظر في طلبات إقامة أخرى مع بقاء الرمز، على أن ينتهي حظر الدخول لمدة خمس سنوات في كل الأحوال للقبول.</p>",
      },
      {
  ...
  ru: {
    ...
    excerpt:
      "Код ограничения V-70 налагается на иностранцев, у которых установлен фиктивный брак для получения ВНЖ. Это может повлечь выдворение, пятилетний запрет въезда в Türkiye, аннулирование семейного ВНЖ и отказ в новых заявлениях. В статье описаны основания, снятие кода и правовые средства.",
    shortDescription:
      "Код V-70 вносится против иностранцев, чей брак для целей проживания признан фиктивным. Он влечет выдворение, отмену разрешения и пятилетний запрет на въезд, но может быть оспорен в административном и судебном порядке.",
    heroTitle: "Код ограничения V-70",
    heroSubtitle:
      "Узнайте, что означает код V-70, почему он вносится после выявления фиктивного брака, как снять его через возражение или иск об отмене и какие есть варианты с аннотированной визой.",
    sections: [
      {
        title: "Код ограничения V-70",
        content:
          "<p>Код V-70 налагается на иностранцев, выдворяемых из-за фиктивного брака, с запретом въезда в Türkiye на пять лет. В результате может быть утрачено гражданство, аннулирован ВНЖ. Иностранцу с V-70 следует использовать правовые средства защиты.</p>",
      },
      {
        title: "Что такое код ограничения V-70?",
        content:
          "<p>Код V-70 вносится в записи иностранцев, у которых установлен фиктивный брак, чтобы блокировать въезд. Семейный ВНЖ аннулируется, повторные заявления по тому же основанию отклоняются. Заявления на иные типы ВНЖ могут рассматриваться при сохранении кода, если пятилетний запрет въезда в любом случае истек.</p>",
      },
      {
        title: "Почему вносится код V-70?",
        content:
          "<p>Код V-70 вводится для выдворения иностранцев с фиктивным браком для получения ВНЖ и запрета въезда в Türkiye на пять лет. Семейный ВНЖ также аннулируется.</p><p>Фиктивность брака устанавливается компетентными органами на основании конкретных данных. Совместное проживание важно, но недостаточно. Деятельность, несовместимая с браком, часто квалифицируется как проституция.</p>",
      },
      {
        title: "Как снять код V-70?",
        content:
          '<p>Код V-70 снимается через административное возражение или суд. Пятилетний запрет въезда прекращается автоматически по истечении срока.</p>Административное возражение<p>Первое средство - мотивированное заявление в компетентный орган, Президентство по делам миграции. Срок - <strong>60 дней</strong> со дня после уведомления.</p><p>Необходимо доказать, что брак не был заключен для ВНЖ или гражданства. Если союз продолжается, это подтверждается. Если прекратился, доказывается его изначальное существование.</p><p>Решение принимается в течение <strong>30 дней</strong>. Молчание означает отказ и право на иск.</p>Иск об отмене<p>Иск подается против Президентства по делам миграции. При отказе возможно обжалование в региональный административный суд.</p><p>Нужно отдельно ходатайствовать об обеспечительных мерах; сам иск не приостанавливает код автоматически.</p>Въезд по аннотированной визе<p>Аннотированная виза выдается по семейным, медицинским и иным основаниям. Ее держатель может въехать даже при V-70.</p><p>Выдача на усмотрение администрации. См. статью о получении аннотированной визы.</p>',
      },
      {
        title: "Иск об отмене решения о выдворении",
        content:
          '<p>Против решения о выдворении на основании кода подается иск в течение <strong>7 дней</strong> с уведомления. До решения суда выдворение не исполняется.</p><p>Компетентен административный суд провинции губернаторства, вынесшего решение. Срок рассмотрения обычно <strong>4-6 месяцев</strong>.</p><p>При отказе апелляция и кассация недоступны, но возможно индивидуальное обращение в Конституционный суд.</p><p>Подача иска о выдворении непосредственно приостанавливает исполнение.</p>Возражение против административного задержания<p>Лица в центрах удержания должны оспорить задержание для освобождения на время дела.</p><p>Возражение в суд мировых судей провинции или места задержания.</p>',
      },
      {
        title: "Сколько длится снятие кода V-70?",
        content:
          "<p>На практике снятие кода занимает около года, при обжаловании - до нескольких лет.</p>",
      },
      {
        title: "Гонорары и судебные расходы по снятию кода",
        content: TAHDIT_COURT_COSTS.ru,
      },
      {
        title: "Компетентный суд для снятия кода ограничения",
        content: COMPETENT_COURT_TAHDIT.ru,
      },
      {
        title: "Заключение",
        content:
          "<p>Код V-70 налагается при фиктивном браке для семейного ВНЖ. Возможны выдворение, отмена разрешений и пятилетний запрет. Необходимо использовать правовые средства. Консультация специализированного адвоката важна для успешного исхода.</p>",
      },
    ],
  },
  fa: {
    ...
    excerpt:
      "کد محدودیت V-70 علیه اتباع خارجی که ازدواج صوری برای اخذ اقامت برای آنها ثابت شود وضع می‌شود. ممکن است به اخراج، ممنوعیت ورود پنج‌ساله به Türkiye، لغو اقامت خانوادگی و رد درخواست‌های جدید منجر شود. این راهنما علل، رفع کد و راه‌های حقوقی را توضیح می‌دهد.",
    shortDescription:
      "کد V-70 برای خارجیانی ثبت می‌شود که ازدواجشان برای اقامت صوری تشخیص داده شود. اخراج، لغو مجوز و ممنوعیت ورود پنج‌ساله به دنبال دارد و قابل اعتراض اداری و قضایی است.",
    heroTitle: "کد محدودیت V-70",
    heroSubtitle:
      "با معنای کد V-70، دلایل وضع آن پس از ازدواج صوری، نحوه رفع از طریق اعتراض یا دعوای ابطال و گزینه ویزای مشروح آشنا شوید.",
    sections: [
      {
        title: "کد محدودیت V-70",
        content:
          "<p>کد V-70 علیه خارجیانی وضع می‌شود که به دلیل ازدواج صوری اخراج شده و ورودشان به Türkiye برای پنج سال ممنوع می‌شود. در نتیجه ممکن است تابعیت لغو و اقامت ابطال شود. خارجی دارای V-70 باید از راه‌های حقوقی استفاده کند.</p>",
      },
      {
        title: "کد محدودیت V-70 چیست؟",
        content:
          "<p>کد V-70 در پرونده خارجیانی ثبت می‌شود که ازدواج صوری برای آنها ثابت شده است. اقامت خانوادگی لغو و درخواست مشابه رد می‌شود. درخواست انواع دیگر اقامت ممکن است با باقی ماندن کد بررسی شود، مشروط بر پایان ممنوعیت پنج‌ساله.</p>",
      },
      {
        title: "چرا کد V-70 وضع می‌شود؟",
        content:
          "<p>V-70 برای اخراج خارجیان با ازدواج صوری برای اقامت و ممنوعیت ورود پنج‌ساله به Türkiye وضع می‌شود. اقامت خانوادگی نیز لغو می‌گردد.</p><p>صوری بودن ازدواج با تحقیق مراجع صلاح بر اساس ادله مشخص ثابت می‌شود. سکونت مشترک مهم اما کافی نیست. فعالیت ناسازگار با زندگی زناشویی، اغلب فحشا تلقی می‌شود.</p>",
      },
      {
      ...
      },
      {
        ...
        content:
          '<p>علیه تصمیم اخراج مبتنی بر کد، ظرف <strong>7 روز</strong> از ابلاغ دعوا طرح می‌شود. تا صدور رأی اخراج اجرا نمی‌شود.</p><p>دادگاه صالح، اداری استان والی صادرکننده تصمیم است. معمولاً <strong>4-6 ماه</strong> طول می‌کشد.</p><p>در صورت رد، تجدیدنظر و فرجام نیست، اما شکایت فردی به دیوان عالیان ممکن است.</p><p>طرح دعوای ابطال اخراج مستقیماً اجرا را متوقف می‌کند.</p>اعتراض به نظارت اداری<p>محبوسان در مراکز بازگشت باید برای آزادی در جریان دعوا اعتراض کنند.</p><p>اعتراض به دادگاه صلح جنایی استان یا محل بازداشت.</p>',
      },
      {
        title: "رفع کد V-70 چقدر طول می‌کشد؟",
        content:
          "<p>در عمل حدود یک سال است و با مراجعه به مراحل تجدیدنظر ممکن است چند سال شود.</p>",
      },
      {
        title: "حق‌الزحمه و هزینه دعوای رفع کد محدودیت",
        content: TAHDIT_COURT_COSTS.fa,
      },
      {
        title: "دادگاه صالح برای رفع کد محدودیت",
        content: COMPETENT_COURT_TAHDIT.fa,
      },
      {
        title: "نتیجه‌گیری",
        content:
          "<p>V-70 برای ازدواج صوری جهت اقامت خانوادگی وضع می‌شود و ممکن است اخراج، لغو مجوزها و ممنوعیت پنج‌ساله به دنبال داشته باشد. خارجی باید راه‌های حقوقی را دنبال کند. مشورت با وکیل متخصص حقوق اتباع خارجی برای نتیجه مطلوب مهم است.</p>",
      },
    ],
  },
};
