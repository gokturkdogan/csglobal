/**
 * Builds batch 2 FC content translation .ts files.
 * Run: node prisma/scripts/build-batch2-fc-translations.mjs
 */
import fs from "fs";
...
const DATA_DIR = path.join(__dirname, "batch2-fc-translation-data");
