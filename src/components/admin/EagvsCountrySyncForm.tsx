    ...
    >
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">
          Örnek: https://www.eagvs.com/avusturya-vizesi. Ana içerik ülke detayına yazılır;
          sol paneldeki linkler blog veya konsolosluk olarak aktarılır.
        </p>
        <input
          name="url"
          type="url"
      ...
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-xs text-slate-600">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-4">
          <li>Ülke detay bölümleri (detailSectionsJson) güncellenir, diğer ülke alanlarına dokunulmaz.</li>
          <li>Sol panel linkleri blog olarak kaydedilir (ülke bağlantısı ile).</li>
          <li>Konsolosluk ofis linkleri konsolosluk kaydı olarak aktarılır.</li>
          <li>PDF ve Dilekçe ve Formlar grubu atlanır.</li>
        </ul>
      </div>
