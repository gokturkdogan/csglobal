...
/** Blog liste sayfası hero: Cloudinary Guides/list-hero */
export const guidesListHeroImageSlot = {
  publicId: buildGuidesListHeroPublicId(),
  label: "Bloglarımız hero görseli",
  aspectRatio: GUIDE_HERO_CROP_ASPECT,
  cropHint:
    "Blog liste hero alanı (~3.2:1). Görseli sürükleyip yakınlaştırarak hangi bölümün görüneceğini seçin.",
};
